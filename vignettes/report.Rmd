...
```{r echo=FALSE, fig.align='center', fig.pos="H", out.width = '50%',out.height='50%',fig.cap="\\label{fig:triangle}Example of edge, 2-star and triangle"}
