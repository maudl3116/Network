...
## Exchange algorithm
```{r echo=FALSE,fig.pos="H",fig.height = 4,fig.width=10,fig.align = "center",fig.cap="\\label{fig:exchange}Title"}

env=environment()
load('ExchangeErgm_10000.RData',env=env)
Liang = env$Liang
par(mfrow=c(2,2))
ts.plot(Liang[,1], ylab="theta1")
ts.plot(Liang[,2], ylab="theta2")
ts.plot(Liang[,3], ylab="theta3")
ts.plot(Liang[,4], ylab="theta4")
...
```{r echo=FALSE,fig.pos="H",fig.height = 4,fig.width=10,fig.align = "center",fig.cap="\\label{fig:exchange}Title"}
par(mfrow=c(2,2))
hist(Liang[,1], main="Historgam of theta1")
hist(Liang[,2], main="Historgam of theta2")
hist(Liang[,3], main="Historgam of theta3")
hist(Liang[,4], main="Historgam of theta4")
```
